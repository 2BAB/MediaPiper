...
/// \param options The options of type <code>LlmInference.Options</code> to use for configuring the <code>LlmInference</code>.
///
///
/// throws:
...
/// Creates a new instance of <code>Options</code> with the modelPath and default values of
/// <code>maxTokens</code>, <code>topK``, </code>temperature<code>and</code>randomSeed`.
